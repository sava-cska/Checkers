...
private:
  ...
  bool check_ordinary(number_of_player player, board_cell from,
                      board_cell to) const;
  bool check_queen(number_of_player player, board_cell from,
                   board_cell to) const;
...
public:
  ...
  bool check_move(number_of_player player, board_cell from,
                  board_cell to) const;
  void move(number_of_player player, board_cell from, board_cell to);
  std::vector<board_cell> get_list_of_correct_moves(number_of_player player,
